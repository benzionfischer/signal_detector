...
class Mhz433(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Mhz433")
...
def main(top_block_cls=Mhz433, options=None):
